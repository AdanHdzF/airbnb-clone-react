		...
		return (
			<div className="property-details-container">
				<div className="property-not-found">
					...
					<p>
						The property you're looking for doesn't exist or hasn't
						been loaded yet.
					</p>
				...
				<div className="content-main">
						...
						<div className="property-highlights">
							...
							<div className="highlight-item">
								...
								<div>
									...
									<p>
										100% of recent guests rated{' '}
										{property.host} 5-star in communication.
									</p>
								</div>
							</div>
						</div>
					...
					<section className="description-section">
						<p className="airbnb-description">
							Experience the perfect blend of comfort and style in
							this beautiful {property.type.toLowerCase()}.
							Located in the heart of {property.location}, this
							space offers everything you need for an
							unforgettable stay. Whether you're traveling for
							business or pleasure, you'll find this property
							perfectly suited to your needs with modern amenities
					...
					<section className="reviews-section">
						...
						<button className="show-all-reviews">
							Show all {Math.floor(Math.random() * 200) + 50}{' '}
							reviews
						</button>
					</section>
				</div>
					...
					<div className="booking-card-airbnb">
						...
						<div className="booking-form">
							...
							<div className="guests-selector">
								<label>GUESTS</label>
								{/* <select
									defaultValue={property.guests > 2 ? 2 : 1}
								>
									{Array.from(
							...
							<div className="price-breakdown">
								...
								<div className="price-row">
									...
									<span>
										${Math.floor(property.price * 0.14)}
									</span>
								</div>
